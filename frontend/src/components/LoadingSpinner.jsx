...
const LoadingSpinner = ({
  ...
  const spinnerContent = (
    <div
      className={`${styles.spinnerContainer} ${fullScreen ? styles.fullScreen : ""}`}
    >
      {overlay && <div className={styles.overlay}></div>}
      <div
        className={`${styles.spinnerWrapper} ${fullScreen ? styles.centered : ""}`}
      >
  ...
  if (fullScreen) {
    return <div className={styles.fullScreenContainer}>{spinnerContent}</div>;
  }
...
export const DotSpinner = ({
  ...
  const spinnerContent = (
    ...
    >
      {overlay && <div className={styles.overlay}></div>}
      <div
        className={`${styles.dotSpinnerWrapper} ${fullScreen ? styles.centered : ""}`}
      >
...
export const PulseSpinner = ({
  ...
  const spinnerContent = (
    ...
    >
      {overlay && <div className={styles.overlay}></div>}
      <div
        className={`${styles.pulseSpinnerWrapper} ${fullScreen ? styles.centered : ""}`}
      >
        <div
          className={`${styles.pulseSpinner} ${sizeClass} ${colorClass}`}
        ></div>
        {label && <span className={styles.label}>{label}</span>}
      </div>
    </div>
...
export const RingSpinner = ({
  ...
  const spinnerContent = (
    ...
    >
      {overlay && <div className={styles.overlay}></div>}
      <div
        className={`${styles.ringSpinnerWrapper} ${fullScreen ? styles.centered : ""}`}
      >
        <div
          className={`${styles.ringSpinner} ${sizeClass} ${colorClass}`}
        ></div>
        {label && <span className={styles.label}>{label}</span>}
      </div>
    </div>
