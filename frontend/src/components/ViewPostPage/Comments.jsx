...
import { properDate } from "../../utils/utils";
          ...
          <div className={styles.commentAvatar}>
            {comment?.author.profile_picture ? (
              <div
                ...
                style={{
                  backgroundImage: `url(${comment.author.profile_picture})`,
                }}
              ></div>
            ) : (
            ...
            <div className={styles.commentContent}>
              <p className={styles.commentText}>
                <span
                  ...
                  onClick={() => {
                    handleGoToCommentsProfile(comment?.author.username);
                  }}
                >
