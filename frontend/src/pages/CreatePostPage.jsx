          ...
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.headline}>
              ...
              <p className={styles.headlineSubtitle}>
                Share your latest moments with your community
              </p>
            </div>
              ...
              <div className={styles.composerSection}>
                ...
                <div className={styles.userHeader}>
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBhhvWt8zuVNDXoW2G8ub1GwHtMd0Jh7m25nxgdz8-oPy4A16qKll5iWpj9rvubffO6dd5cO4s04jM5PkdGs6XlpyNSlRTWDi_WnlkGzTIM5LP9okkqiANhCKD5fiONym4w2cJJ8ZwI91E6Pq5qjRHKYqriV_OtQNwnCjoo5k_BxAtHeVftcAMfe66Km5XHqjGFGqBrY4hZUYvz7gQEY22QicyUlOLQtgP2TPhmnGcM6Y-BS04KqZOe7iGstteQ9Crbgx46TFYyl0x4")',
                    }}
                  ></div>
                  <div>
                ...
                <div className={styles.actionFooter}>
                  ...
                  <button className={styles.submitButton} onClick={handlePost}>
