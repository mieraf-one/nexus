        ...
        <section className={styles.heroSection}>
          <div className={styles.heroContainer}>
            <h1 className={styles.heroTitle}>
              Connect{" "}
              <span className={styles.gradientText}>Beyond Limits.</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Join Nexus, the vibrant community where creativity meets
              connection. Share your world, discover new passions, and find your
              people.
            </p>
          ...
          <div className={styles.statsContainer}>
            ...
            <div className={styles.avatarStack}>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://lh3.googleusercontent.com/aida-public/AB6AXuCFniLr9qQ4CyMr7gt_qH24PZq4DIBiAoXewcG0PV1tilRCyEE5kMENVO3PA-BDYFeOKp7kX8wLfwEJ7ZRaCM6Ud8MX5XZDJq6NEABH8fIRUGzXPC6ZeahQeSXt3Oa6rC6shhdl7b_wCOM-H3QW55eMINzf5nKVUeAU7LLFct__MMyEYJU2RHCLjJyBt7W67fYv2aDn3cgLs6PH2aZp-ZMtuDpkiGGAzqykfmuNHuzPHu9tTsS8fRgCCkt0wyDv4Dqny52Kj7EZpN3y)",
                }}
              ></div>
              <div
                className={styles.avatar}
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://lh3.googleusercontent.com/aida-public/AB6AXuCCAvytpHetbHBoclqocctShLueN0d3j1vLCCILREkyMzOLXw9e5auSU6C6KoAjoQ2RDfwPu_2Bz6AF5hswBmDaiWEhs4YWbqSiRostSwEYvn_Y0E3FJYNO4yFegf-hzyglelo9Fud_Ck0lSLrw7f10Dk82uT4A_LJrL3WBfxT1285e-0ljpmVhW59dduWOmxRWfsd2HJA7qBMQwYEKWRBeUIf7R8UoQREBSS3a4qi9hG7SEwWyEtGhtLJy_79YA2DDQN-3P-qFLOjL)",
                }}
              ></div>
              <div
                className={styles.avatar}
            ...
            <p className={styles.statsSubtitle}>
              Trusted by over 10,000 communities worldwide
            </p>
          </div>
        </section>
          ...
          <div className={styles.featuresContainer}>
            <div className={styles.featuresHeader}>
              ...
              <p className={styles.featuresSubtitle}>
                Designed for connection, built for you. Discover tools that
            ...
            <div className={styles.featuresGrid}>
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  Connect effortlessly with friends and like-minded groups who
                  share your specific passions and interests.
                </p>
              </div>
              ...
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  Share photos, videos, and stories with intuitive creative
                  tools designed to make your content pop.
                </p>
              </div>
              ...
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  A personalized feed algorithm that cuts through the noise and
                  brings the best content directly to you.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.ctaContainer}>
            ...
            <div className={styles.ctaContent}>
              ...
              <p className={styles.ctaSubtitle}>
                Join the fastest growing social network today and see what
