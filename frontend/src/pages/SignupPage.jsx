      ...
      <header className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <div className={styles.headerActions}>
            <span className={styles.memberText}>Already a member?</span>
        ...
        <div className={styles.contentGrid}>
          ...
          <div className={styles.heroSection}>
            ...
            <p className={styles.heroDescription}>
              Create an account to connect with friends, share your passions,
              and discover a world of creativity waiting for you.
            </p>
          ...
          <div className={styles.signupCard}>
            ...
            <div className={styles.formContainer}>
              ...
              <p className={styles.formSubtitle}>
                Fill in your details to get started with Nexus.
              </p>
